...
-- NERDCommenter
vim.api.nvim_set_keymap("x", "<leader>cs", [[<Plug>NERDCommenterSexy]], {noremap = false, silent = true, expr = false})
vim.api.nvim_set_keymap("n", "<leader>cs", [[<Plug>NERDCommenterSexy]], {noremap = false, silent = true, expr = false})
vim.api.nvim_set_keymap("x", "<leader>cu", [[<Plug>NERDCommenterUncomment]], {noremap = false, silent = true, expr = false})
vim.api.nvim_set_keymap("n", "<leader>cu", [[<Plug>NERDCommenterUncomment]], {noremap = false, silent = true, expr = false})
vim.api.nvim_set_keymap("x", "<leader>co", [[<Plug>NERDCommenterToggle]], {noremap = false, silent = true, expr = false})
vim.api.nvim_set_keymap("n", "<leader>co", [[<Plug>NERDCommenterToggle]], {noremap = false, silent = true, expr = false})
vim.api.nvim_set_keymap("x", "<leader>cc", [[<Plug>NERDCommenterComment]], {noremap = false, silent = true, expr = false})
